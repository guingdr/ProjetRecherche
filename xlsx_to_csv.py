...
path = r'C:\Users\guilh\Desktop\integratorProject\mydatasets'
...
for file in os.scandir(path + '\\xlsx'):
    read_file = pd.read_excel(path + '\\xlsx\\' + file.name + '.xlsx')
    read_file.to_csv(path + '\\csv\\' + file.name + '.csv', index = None, header=True)
